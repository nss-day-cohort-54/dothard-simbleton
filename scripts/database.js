...
export const NYBusinesses = (state) => {
  const filteredBusiness = businesses.filter(business => business.addressStateCode === state)
  return filteredBusiness
}

export const filteredManufacturingBusinesses = () => {
  const manBusiness = businesses.filter(business => business.companyIndustry === "Manufacturing")
  return manBusiness
}
